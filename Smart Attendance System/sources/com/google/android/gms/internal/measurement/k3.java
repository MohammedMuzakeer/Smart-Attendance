...
interface k3 {
    ...
    <K, V> void a(int i, o1<K, V> o1Var, Map<K, V> map) throws IOException;

    void a(int i, zzte zzte) throws IOException;

    void a(int i, Object obj) throws IOException;

    void a(int i, Object obj, d2 d2Var) throws IOException;

    void a(int i, String str) throws IOException;

    void a(int i, List<zzte> list) throws IOException;

    @Deprecated
    void a(int i, List<?> list, d2 d2Var) throws IOException;
    ...
    @Deprecated
    void b(int i, Object obj, d2 d2Var) throws IOException;

    void b(int i, List<String> list) throws IOException;

    void b(int i, List<?> list, d2 d2Var) throws IOException;
