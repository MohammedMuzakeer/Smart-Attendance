...
interface wx {
    ...
    <K, V> void a(int i, uv<K, V> uvVar, Map<K, V> map) throws IOException;

    void a(int i, zzdmr zzdmr) throws IOException;

    void a(int i, Object obj) throws IOException;

    @Deprecated
    void a(int i, Object obj, nw nwVar) throws IOException;

    void a(int i, String str) throws IOException;

    void a(int i, List<zzdmr> list) throws IOException;

    @Deprecated
    void a(int i, List<?> list, nw nwVar) throws IOException;
    ...
    void b(int i, Object obj, nw nwVar) throws IOException;

    void b(int i, List<String> list) throws IOException;

    void b(int i, List<?> list, nw nwVar) throws IOException;
